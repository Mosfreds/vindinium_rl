"""Contains a class representing a Vindinium game (state)."""
...
class Game(object):
    ...
    def update(self, state):
        """Update the game with new information.
        ...
        for hero, hero_state in zip(self.heroes, heroes):
            ...
            hero.x = hero_state['pos']['x']
            hero.y = hero_state['pos']['y']
    ...
    def _process_state(self, state):
        ...
        for hero in state['game']['heroes']:
            ...
            self.map[pos['x'], pos['y']] = vin.TILE_SPAWN
